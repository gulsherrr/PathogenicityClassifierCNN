...
This project was built from scratch over eight structured days, moving from foundational setup to real biological data and GPU-accelerated training.
...
Opened the first notebook and practiced NumPy warm-ups.
...
BetterCNNv2 (trained on chr1, chr2, chr3, chr22)

Validation AUROC: 0.81

Demonstrates the model’s ability to distinguish pathogenic from benign variants by learning meaningful sequence patterns.

Loss and AUROC curves are available in the reports/figures/ folder.
